...
EXEC_SCRIPT_NAME: str = "license_check_transform_ray.py"
PREFIX: str = ""
...
def license_check(
    # Ray cluster
    ray_name: str = "license_check-kfp-ray",  # name of Ray cluster
    ...
    # data access
    data_s3_config: str = "{'input_folder': 'test/license_check/input/', 'output_folder': 'test/license_check/output/'}",
    ...
    # license check parameters
    lc_license_column_name: str = "license",
    lc_licenses_file: str = "test/license_check/sample_approved_licenses.json",
...
if __name__ == "__main__":
    ...
    compiler.Compiler().compile(license_check, __file__.replace(".py", ".yaml"))
