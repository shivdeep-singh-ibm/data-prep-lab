...
from repo_level_order_transform_ray import repo_level_orderRayTransformConfiguration


print(os.environ)
# create launcher
launcher = RayTransformLauncher(repo_level_orderRayTransformConfiguration())
# create parameters
s3_cred = {
...
s3_conf = {
    "input_folder": "test/repo_level_ordering/input",
    "output_folder": "test/repo_level_ordering/output",
}
